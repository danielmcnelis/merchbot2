...
client.on('guildMemberUpdate', async (oldMember, newMember) => {
    try {
        ...
        const hadForgedEnchantments = oldRoles.has('1518396406090698885') || oldRoles.has('1511009496720478299')
        const gotForgedEnchantments = newRoles.has('1518396406090698885') || newRoles.has('1511009496720478299')
