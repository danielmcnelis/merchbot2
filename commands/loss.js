...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            const content = `${losingPlayer.name} (+3<:starchips:1374362231109718117>), your Arena ${arena} loss to <@${winningPlayer.discordId}> (+5<:starchips:1374362231109718117>) has been recorded.`
