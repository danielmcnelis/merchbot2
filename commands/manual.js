...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            const content = `A manual Arena ${arena} loss by <@${losingPlayer.discordId}> (+4<:starchips:1488939806053498931>)  to <@${winningPlayer.discordId}> (+8<:starchips:1488939806053498931>) has been recorded.`
