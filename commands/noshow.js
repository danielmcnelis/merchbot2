...
export default {
    ...
    async execute(interaction) {
        try {
            ...
            const content = `A no-show Arena ${arena} loss by <@${losingPlayer.discordId}> to <@${winningPlayer.discordId}> (+7<:starchips:1374362231109718117>) has been recorded. ${losingPlayer.name} has been removed from The Arena. ${arena}`
