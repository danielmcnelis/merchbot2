...
const { gladiators, foxy, shrine, cavebob, AOD, CTP, FON, king, arena, aqua, beast, dragon, machine, plant, pyro, rock, spellcaster, warrior, zombie, starchips, ult, mushrooms, gems, bolts, orbs, shields, skulls, droplets, firecrackers, roses, moais } = emojis
...
export const forfeit = async (winnerId, loserId) => {
		...
		winningPlayer.wallet.starchips += 7
		...
		channel.send({ content: `${losingEntry.playerName} (+0${starchips}), your Arena loss to ${winningEntry.playerName} (+7${starchips}) has been recorded.`})
