...
export const getTraderBConfirmation = async (interaction, proposalA, proposalB, traderA, traderB, traderAPackageSummary, traderBPackageSummary) => {
    ...
    const message = await interaction.channel.send({ content: `<@${traderB.discordId}>, Please review both sides of the trade proposal with ${traderA.name} and then confirm "Yes" or "No" that you wish to trade. ${hmmm}\nYou will send:\n${traderBPackageSummary.join('\n')}\n\nYou will receive:\n${traderAPackageSummary.join('\n')}`, components: [row] })
    ...
    try {
        ...
        if (confirmation.customId.includes('Yes')) {
            ...
            // const processTradeComponent = async (interaction, newTransaction, sender, recipient, quantity, print) => {
            ...
            await processTradeComponent(interaction, newTransaction, traderA, traderB, proposalAQuantityA, proposalAPrintA)
            ...
            if (proposalA.forgedPrintBId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderA, traderB, proposalAQuantityB, proposalAPrintB)
            }
            ...
            if (proposalA.forgedPrintCId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderA, traderB, proposalAQuantityC, proposalAPrintC)
            }
            ...
            if (proposalA.forgedPrintDId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderA, traderB, proposalAQuantityD, proposalAPrintD)
            }
            ...
            if (proposalA.forgedPrintEId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderA, traderB, proposalAQuantityE, proposalAPrintE)
            }
            ...
            await processTradeComponent(interaction, newTransaction, traderB, traderA, proposalBQuantityA, proposalBPrintA)
            ...
            if (proposalB.forgedPrintBId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderB, traderA, proposalBQuantityB, proposalBPrintB)
            }
            ...
            if (proposalB.forgedPrintCId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderB, traderA, proposalBQuantityC, proposalBPrintC)
            }
            ...
            if (proposalB.forgedPrintDId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderB, traderA, proposalBQuantityD, proposalBPrintD)
            }
            ...
            if (proposalB.forgedPrintEId) {
                ...
                await processTradeComponent(interaction, newTransaction, traderB, traderA, proposalBQuantityE, proposalBPrintE)
            }
        ...
        await proposalA.destroy()
        await proposalB.destroy()
        return message.edit({ content: `Sorry, time's up. The transaction with ${traderB.name} has been cancelled.`, components: [] });
    }   
}
...
export const getSellerConfirmation = async (interaction, buyer, seller, quantity, print, card, price, buyersInv, sellersInv, buyersWallet, sellersWallet) => {
    ...
    const message = await interaction.channel.send({ content: `<@${sellerDiscordId}> are you sure you want to sell ${quantity}${card} to ${buyer.name} for ${price}${stardust}? ${hmmm}`, components: [row] })
    ...
    try {
        ...
        console.log(err)
        await message.edit({ content: `Sorry, time's up. The transaction with ${buyer.name} has been cancelled.`, components: [] });
    }   
}
...
export const getBuyerConfirmation = async (interaction, buyer, seller, quantity, print, card, price, buyersInv, sellersInv, buyersWallet, sellersWallet) => {
    ...
    const message = await interaction.channel.send({ content: `<@${buyerDiscordId}> are you sure you want to buy ${quantity}${card} from ${seller.name} for ${price}${stardust}? ${hmmm}`, components: [row] })
    ...
    try {
        ...
        console.log(err)
        await message.edit({ content: `Sorry, time's up. The transaction with ${seller.name} has been cancelled.`, components: [] });
    }
}
