    ...
    try {
        ...
        for (let i = 0; i < players.length; i++) {
            try {
                ...
                if (player.isForgedSubscriber && player.discordId !== '192688367585067008' && player.discordId !== '379851431752237057' && player.discordId !== '626843317010694176' && player.discordId !== '332277643384979466' && !member?._roles.includes(benefactorRoleId) && !member?._roles.includes(patronRoleId) && !member?._roles.includes(supporterRoleId)) {
                    ...
                    b++
                } else if (member?._roles.includes(benefactorRoleId) && (!player.isForgedSubscriber || player.forgedSubscriberTier !== 'Benefactor') && player.discordId !== '192688367585067008' && player.discordId !== '379851431752237057' && player.discordId !== '332277643384979466' && player.discordId !== '626843317010694176') {
                    ...
                    a++
                } else if (member?._roles.includes(patronRoleId) && (!player.isForgedSubscriber || player.forgedSubscriberTier !== 'Patron') && player.discordId !== '192688367585067008' && player.discordId !== '379851431752237057' && player.discordId !== '332277643384979466' && player.discordId !== '626843317010694176') {
                    ...
                    a++
                } else if (member?._roles.includes(supporterRoleId) && (!player.isForgedSubscriber || player.forgedSubscriberTier !== 'Supporter') && player.discordId !== '192688367585067008' && player.discordId !== '379851431752237057' && player.discordId !== '332277643384979466' && player.discordId !== '626843317010694176') {
